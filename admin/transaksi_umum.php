...
<body>
<?php
	$param="SELECT * FROM umum WHERE no_transaksi='$_GET[id]'";
...
<table width="608" border="0" cellpadding="0" cellspacing="1">
  ...
  <tr>
    ...
    <td width="155" id="noBorder">No. Identitas</td>
    <td width="23" id="noBorder">:</td>
    <td width="97" id="noBorder"><?php echo $dparam['no_identitas']; ?></td>
  </tr>
  <tr>
    ...
    <td id="noBorder">:</td>
    <td id="noBorder"><?php echo $dparam['alamat']; ?></td>
  </tr>
  <tr>
...
<?php
  	$sql="SELECT * FROM umum WHERE no_transaksi='$_GET[id]' ORDER BY no_transaksi ASC";
	...
	$tgl_trans= tgl_indo($data['tgl_transaksi']);
  ?>
  <tr>
  	<td id="noBorder"><div align="center"><?php echo $no; ?></div></td>
    <td id="noBorder"><div align="center"><?php echo $tgl_trans; ?></div></td>
    <td align="center" id="noBorder"><div align="center"><?php echo digit($data['jumlah_bayar']); ?></div></td>
  </tr>
  <?php $no++; } ?>
</table>
<p>&nbsp;</p>
<table width="608" border="0">
  <tr>
    ...
    <td width="339" id="noBorder"><div align="center">EWC fitnes center </div></td>
  </tr>
  <tr>
    <td id="noBorder"> <p>&nbsp;</p>
    <p align="center">&nbsp;</p>
