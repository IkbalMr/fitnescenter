...
<div id="judulHalaman"><strong>Data Class Member</strong></div>
<table border="0" cellspacing="1" cellpadding="0">
<?php echo "<a href=form_class.php>"; ?>
...
<table border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td id="noborder"><table cellpadding="0" cellspacing="1">
          <tr>
			...
			<td id="namaField">Nama Class</td>
			<td id="namaField">ID Memeber</td>
	...
	$query=mysql_query("SELECT * FROM class ORDER BY tanggal DESC LIMIT $posisi,$batas");
	$no=$posisi+1;
	...
	//penomoran
	$tampil2 = mysql_query("SELECT * FROM class ");
		...
		echo "</div>";
		echo "<p align=left>Total Record Class : <b>$jmldata</b> Member</p>";
		?>
		</table></td>        
      	</tr>
	</table>
