...
<div id="judulHalaman"><strong>Data Pengunjung Non Member</strong></div>
<table border="0" cellspacing="1" cellpadding="0">
  <tr>
    <td>
    <form id="form1" name="form1" method="post" action="guest_cari.php">
      <table cellspacing="1" cellpadding="0">
        ...
        <tr>
		  ...
		  <option value='telepon' >No. HP/BBM</option>
 ...
 ?> 
      <table cellpadding="0" cellspacing="1">
		...
		<?php echo "<a href=index.php?halaman=form_data&kode=guest_insert>"; ?>
	...
	$qp_sup=mysql_query("SELECT * FROM guest order by inc DESC LIMIT $posisi,$batas");
	$no=$posisi+1;
