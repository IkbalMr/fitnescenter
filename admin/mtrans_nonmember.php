...
<div id="judulHalaman"><strong>Transaksi NonMember</strong></div>
<table border="0" cellspacing="1" cellpadding="0">
  <tr>
      <td >
    <form id="form1" name="form1" method="post" action="mtrans_nonmembercari.php">
 ...
 <td>
    <form id="form2" name="form2" method="post" action="mtranst_nonmembercari.php">
      <table >
        <tr>
 ...
 ?> 
	...
	$sum1="SELECT SUM(jumlah_bayar) AS total FROM umum";
	...
	$no=$posisi+1;
		...
		?>
		<tr>
		<td style="color:#FFF;border:none;background-color:#333" colspan="7" align="right">Total Seluruh Transaksi NonMember :</td>
